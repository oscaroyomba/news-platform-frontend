  ...
  return (
    <article className="group overflow-hidden border border-[var(--border)] bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
      <div className="grid gap-0 md:grid-cols-12">
        ...
        <div className="p-4 md:col-span-7 md:p-5">
          <Link href={href} className="block" aria-label={title} title={title}>
            <h3 className="font-[var(--font-serif)] text-xl font-bold leading-snug tracking-tight group-hover:underline decoration-[var(--accent)] underline-offset-4">
              {title}
            </h3>
